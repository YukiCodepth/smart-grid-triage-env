...
Low
Load Balancing
Reroute power via tie-breaker E7 to prevent a 92% thermal spike on E1.
Medium
Moderate
Fault Isolation
Isolate a short-circuit on N3 while maintaining N1/N2 uptime.
Hard
High
Critical Rerouting
Shed residential load (N4) to preserve the Hospital (N1) during a primary substation failure.
